...
global.idchannel = '120363417252896376@newsletter'
global.namechannel = 'ᴵᴬᴹ 𝗜𝘁𝘀𝘂𝗸𝗶 𝗡𝗮𝗸𝗮𝗻𝗼-𝗜𝗔⏤͟͟͞͞🌺'
  ...
  global.ppkecil = {
    contextInfo: {
      externalAdReply: {
        ...
        body: global.author,
  thumbnail: fs.readFileSync("./src/Images/Nagi-BotV1.jpg"),
  ...
  global.adReplyS = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        ...
        previewType: "PHOTO",
  thumbnail: fs.readFileSync("./src/Images/Nagi-Bot.jpg"),
        sourceUrl: "https://whatsapp.com/channel/0029VbBQ5sf4NVioq39Efn0v",
      }
    }
  }
